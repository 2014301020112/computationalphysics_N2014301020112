...
ax4=plt.subplot(224)
plt.sca(ax1)
a,b,c,d=tra(3.0,200000)
plt.plot(a,b,color='orange',label='trajectory of earth')
plt.plot(c,d,color='purple',label='trajectory of jupiter')
plt.legend(loc='upper right')
plt.xlabel('X(AU)')
plt.ylabel('Y(AU)')
plt.title('the asteriod at 3.0AU')
plt.sca(ax2)
a,b,c,d=tra(3.276,200000)
plt.plot(a,b,color='orange',label='trajectory of earth')
plt.plot(c,d,color='purple',label='trajectory of jupiter')
plt.legend(loc='upper right')
plt.xlabel('X(AU)')
plt.ylabel('Y(AU)')
plt.title('the asteriod at 3.276AU')
plt.sca(ax3)
a,b,c,d=tra(3.500,200000)
plt.plot(a,b,color='orange',label='trajectory of earth')
plt.plot(c,d,color='purple',label='trajectory of jupiter')
plt.legend(loc='upper right')
plt.xlabel('X(AU)')
plt.ylabel('Y(AU)')
plt.title('the asteriod at 3.500AU')
plt.sca(ax4)
a,b,c,d=tra(3.7,200000)
plt.plot(a,b,color='orange',label='trajectory of earth')
plt.plot(c,d,color='purple',label='trajectory of jupiter')
plt.legend(loc='upper right')
plt.xlabel('X(AU)')
plt.ylabel('Y(AU)')
plt.title('the asteriod at 3.7AU')
plt.show()
